...
This project serves as my first multi-file project and my first experience using GitHub for version control. I've been looking for a pricer like this for a long time, but I couldn't find a free tool that could both price exotic options and display Greeks in a clear and interactive way.  
